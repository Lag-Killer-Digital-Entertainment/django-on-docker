"""
Django settings for {{cookiecutter.project_slug_name}} project.
...
ROOT_URLCONF = "{{cookiecutter.project_slug_name}}.urls"
...
WSGI_APPLICATION = "{{cookiecutter.project_slug_name}}.wsgi.application"
